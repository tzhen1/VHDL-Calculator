...
HD_PWD='C:/Users/Ray/Documents/Vivado_Projects/assignment_2_TEST/minized_vivado-only_template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyncPS_ClockGen_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyncPS_ClockGen_wrapper.tcl
